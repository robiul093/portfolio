    ...
    return (
        <div className="md:w-[60%] mx-auto min-h-screen my-10">
            <div className="card bg-base-100 w-full shrink-0 shadow-2xl">
                <h1 className="text-4xl font-bold text-center py-5 border-b-2 w-[60%] mx-auto">Login Your Account</h1>
                ...
                <p className="text-black/45 flex justify-center my-5 font-normal text-[16px]">Don`t have an account? <Link href='/register' className="underline ml-1">Register</Link></p>
            </div>
        </div>
    )
}
